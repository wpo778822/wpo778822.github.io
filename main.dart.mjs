...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1338: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      ...
      _1396: s => JSON.stringify(s),
      _1397: s => printToConsole(s),
      ...
      _1409: Object.is,
      _1410: o => o instanceof Array,
      _1411: (a, i) => a.push(i),
      _1412: (a, i) => a.splice(i, 1)[0],
      _1413: (a, i, v) => a.splice(i, 0, v),
      _1414: (a, l) => a.length = l,
      _1415: a => a.pop(),
      _1416: (a, i) => a.splice(i, 1),
      _1417: (a, s) => a.join(s),
      _1418: (a, s, e) => a.slice(s, e),
      _1420: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1421: a => a.length,
      ...
      _1427: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1428: o => o instanceof DataView,
      _1429: o => o instanceof Uint8Array,
      _1430: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1431: o => o instanceof Int8Array,
      _1432: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1433: o => o instanceof Uint8ClampedArray,
      _1434: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1435: o => o instanceof Uint16Array,
      _1436: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1437: o => o instanceof Int16Array,
      _1438: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1439: o => o instanceof Uint32Array,
      _1440: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1441: o => o instanceof Int32Array,
      _1442: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1444: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1445: o => o instanceof Float32Array,
      _1446: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1447: o => o instanceof Float64Array,
      _1448: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1449: (t, s) => t.set(s),
      _1451: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1453: o => o.buffer,
      _1454: o => o.byteOffset,
      _1455: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1456: (b, o) => new DataView(b, o),
      _1457: (b, o, l) => new DataView(b, o, l),
      _1458: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1459: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1460: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1461: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1462: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1463: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1464: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1465: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1466: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1467: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1468: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1469: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1472: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1473: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1474: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1475: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1476: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1477: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1490: (ms, c) =>
      ...
      _1529: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1529(f,arguments.length,x0,x1) }),
      _1530: o => {
      ...
      _1556: (o, p) => p in o,
      _1557: (o, p) => o[p],
      _1560: () => new XMLHttpRequest(),
      _1561: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      _1573: (x0,x1,x2) => x0.open(x1,x2),
      _1574: x0 => x0.abort(),
      _1575: x0 => x0.getAllResponseHeaders(),
      _1576: (x0,x1) => new WebSocket(x0,x1),
      _1577: (x0,x1) => x0.send(x1),
      _1578: (x0,x1,x2) => x0.close(x1,x2),
      _1580: x0 => x0.close(),
      _1583: x0 => new Blob(x0),
      _1621: x0 => x0.getAvailability(),
      _1623: (x0,x1) => x0.requestDevice(x1),
      _1658: x0 => x0.id,
      _1659: x0 => x0.name,
      _1660: x0 => x0.gatt,
      _1665: (x0,x1) => { x0.ongattserverdisconnected = x1 },
      _1703: x0 => x0.connect(),
      _1704: x0 => x0.disconnect(),
      _1705: (x0,x1) => x0.getPrimaryService(x1),
      _1708: x0 => x0.connected,
      _1709: (x0,x1) => x0.getCharacteristic(x1),
      _1713: x0 => x0.device,
      _1714: x0 => x0.uuid,
      _1729: (x0,x1) => x0.writeValueWithoutResponse(x1),
      _1730: x0 => x0.startNotifications(),
      _1732: x0 => x0.service,
      _1733: x0 => x0.uuid,
      _1734: x0 => x0.properties,
      _1735: x0 => x0.value,
      _1737: (x0,x1) => { x0.oncharacteristicvaluechanged = x1 },
      _1739: x0 => x0.read,
      _1741: x0 => x0.write,
      _1742: x0 => x0.notify,
      _1743: x0 => x0.indicate,
      _1756: () => globalThis.window,
      _1757: x0 => x0.navigator,
      _1758: x0 => x0.bluetooth,
      _1759: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1759(f,arguments.length,x0) }),
      _1760: x0 => ({services: x0}),
      _1761: (x0,x1) => ({filters: x0,optionalServices: x1}),
      _1762: (x0,x1) => ({optionalServices: x0,acceptAllDevices: x1}),
      _1763: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1763(f,arguments.length,x0) }),
      _1764: x0 => x0.getPrimaryServices(),
      _1765: x0 => x0.getCharacteristics(),
      _1766: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1767: (x0,x1) => globalThis.fetch(x0,x1),
      _1768: (x0,x1) => x0.get(x1),
      _1769: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1769(f,arguments.length,x0,x1,x2) }),
      _1770: (x0,x1) => x0.forEach(x1),
      _1771: x0 => x0.abort(),
      _1772: () => new AbortController(),
      _1773: x0 => x0.getReader(),
      _1774: x0 => x0.read(),
      _1775: x0 => x0.cancel(),
      _1776: (x0,x1) => x0.key(x1),
      _1777: x0 => x0.random(),
      _1780: () => globalThis.Math,
      ...
      _1880: x0 => x0.readyState,
      _1882: (x0,x1) => { x0.timeout = x1 },
      _1884: (x0,x1) => { x0.withCredentials = x1 },
      _1885: x0 => x0.upload,
      _1886: x0 => x0.responseURL,
      _1887: x0 => x0.status,
      _1888: x0 => x0.statusText,
      _1890: (x0,x1) => { x0.responseType = x1 },
      _1891: x0 => x0.response,
      _1903: x0 => x0.loaded,
      _1904: x0 => x0.total,
      _1951: (x0,x1) => { x0.draggable = x1 },
      _1967: x0 => x0.style,
      _2896: (x0,x1) => { x0.accept = x1 },
      _2910: x0 => x0.files,
      _2936: (x0,x1) => { x0.multiple = x1 },
      _2954: (x0,x1) => { x0.type = x1 },
      _3673: () => globalThis.window,
      _3713: x0 => x0.document,
      _3735: x0 => x0.navigator,
      _3999: x0 => x0.localStorage,
      ...
      _8808: x0 => x0.url,
      _8810: x0 => x0.status,
      _8812: x0 => x0.statusText,
      _8813: x0 => x0.headers,
      _8814: x0 => x0.body,
      _11220: (x0,x1) => { x0.display = x1 },
